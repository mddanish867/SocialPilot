...
import { FaEye, FaEyeSlash, FaGoogle, FaFacebook, FaUser } from 'react-icons/fa';
      ...
      <div className="w-full max-w-6xl bg-white rounded-2xl shadow-lg overflow-hidden flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2 bg-gray-50 p-8 md:p-12 relative">
          ...
          <div className="relative">
            {/* Balance Card */}
            <div className="bg-white rounded-xl shadow-md p-5 mb-4 w-64 h-36 ml-28">
              <div className="text-xs text-gray-500 mb-1">CURRENT BALANCE</div>
              <div className="text-2xl font-bold text-blue-500">$24,359</div>
            </div>
            ...
            {/* Transaction Button */}
            <div className="bg-white rounded-xl shadow-md p-4 mb-4 flex items-center w-80 h-40 ml-16">
            ...
            {/* Dashboard Message */}
            <div className="mt-12">
              <h2 className="text-xl font-bold mb-3">Welcome to <span className='text-blue-500'>SocilaPilot</span>!</h2>
        ...
        <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
          <div className="max-w-md mx-auto w-full">
            <h1 className="text-2xl font-bold text-gray-800 mb-2">Welcome <span className='text-blue-500'>SocilaPilot</span>!</h1>
